...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Evaluation.submission'
        db.add_column(u'college_evaluation', 'submission',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Evaluation.quality'
        db.add_column(u'college_evaluation', 'quality',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Evaluation.output'
        db.add_column(u'college_evaluation', 'output',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Evaluation.research'
        db.add_column(u'college_evaluation', 'research',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Evaluation.presentation'
        db.add_column(u'college_evaluation', 'presentation',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Evaluation.submission'
        db.delete_column(u'college_evaluation', 'submission')

        # Deleting field 'Evaluation.quality'
        db.delete_column(u'college_evaluation', 'quality')

        # Deleting field 'Evaluation.output'
        db.delete_column(u'college_evaluation', 'output')

        # Deleting field 'Evaluation.research'
        db.delete_column(u'college_evaluation', 'research')

        # Deleting field 'Evaluation.presentation'
        db.delete_column(u'college_evaluation', 'presentation')
    ...
    models = {
        ...
        u'college.evaluation': {
            ...
            'research': ('django.db.models.fields.IntegerField', [], {}),
            'score': ('django.db.models.fields.IntegerField', [], {}),
            'submission': ('django.db.models.fields.IntegerField', [], {}),
