...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'college_project', 'comments')

        # Adding field 'Project.duration'
        db.add_column(u'college_project', 'duration',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Project.progress'
        db.add_column(u'college_project', 'progress',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'college_project', 'comments',
                      self.gf('django.db.models.fields.TextField')(default=0),
                      keep_default=False)

        # Deleting field 'Project.duration'
        db.delete_column(u'college_project', 'duration')

        # Deleting field 'Project.progress'
        db.delete_column(u'college_project', 'progress')
